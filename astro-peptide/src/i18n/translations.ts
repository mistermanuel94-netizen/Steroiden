...
export const translations: Record<SupportedLanguage, Translations> = {
  en: {
    ...
    home: {
      heroBadge: '✓ ISO Certified | 99.9% Pure | Lab Verified',
      heroTitle: 'Premium Research Peptides for',
      heroTitleHighlight: 'Science That Matters',
      heroSubtitle: 'Access world-class research-grade peptides with full traceability, HPLC-verified purity, and complete COA documentation. Trusted by 500+ research labs across Europe.',
      shopNow: 'Shop Now',
