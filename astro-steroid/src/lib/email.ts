...
const SITE_EMAIL = 'steroideshop@zohomail.com';
const OWNER_EMAIL = import.meta.env.OWNER_EMAIL || SITE_EMAIL;
const SITE_NAME = 'Steroiden';
// Default to the domain email since it is verified. Fallback to env var if set.
const SENDER_EMAIL = import.meta.env.SENDER_EMAIL || `Steroiden <noreply@steroideshop.net>`;
  ...
  const bankDetails = isBankTransfer ? `
    <div style="background: #fef3c7; border: 1px solid #f59e0b; border-radius: 8px; padding: 20px; margin: 24px 0;">
      ...
      <table style="width: 100%; font-size: 14px;">
        <tr><td style="padding: 4px 0; color: #78350f;"><strong>Bank:</strong></td><td style="color: #78350f;">Pireaus bank</td></tr>
        <tr><td style="padding: 4px 0; color: #78350f;"><strong>Account Holder:</strong></td><td style="color: #78350f;">Kenfack Awounang Elvis</td></tr>
        <tr><td style="padding: 4px 0; color: #78350f;"><strong>IBAN:</strong></td><td style="color: #78350f;">GR9801710140006014167913531</td></tr>
        <tr><td style="padding: 4px 0; color: #78350f;"><strong>BIC/SWIFT:</strong></td><td style="color: #78350f;">PIRBGRAA</td></tr>
      ...
      <div style="background: #fbbf24; border-radius: 6px; padding: 12px; margin-top: 16px;">
        <p style="color: #78350f; margin: 0; font-weight: 600;">ðŸ“¸ IMPORTANT: Please send a screenshot of your payment confirmation to steroideshop@zohomail.com to speed up order processing.</p>
      </div>
    </div>
  ` : `
    <div style="background: #ecfdf5; border: 1px solid #10b981; border-radius: 8px; padding: 20px; margin: 24px 0;">
      <h3 style="color: #065f46; margin: 0 0 8px 0; font-size: 16px;">₿ Crypto Payment</h3>
      <p style="color: #047857; margin: 0 0 16px 0;">Please complete payment using one of the addresses below. Your order will be processed once payment is confirmed.</p>
      <table style="width: 100%; font-size: 14px;">
        <tr><td style="padding: 4px 0; color: #065f46;"><strong>BTC Address:</strong></td><td style="color: #065f46; word-break: break-all;">1Bb73C1oHfNao6LDtt9t36zCmaY8z4ttMR</td></tr>
        <tr><td style="padding: 4px 0; color: #065f46;"><strong>USDT (TRC20):</strong></td><td style="color: #065f46; word-break: break-all;">TLsUuQUwJcdXF4hCoYJPd6inFgpAuMdNek</td></tr>
      </table>
    </div>
  `;
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: white; border: 1px solid #e2e8f0; border-top: none; padding: 32px; border-radius: 0 0 12px 12px;">
    ...
    <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0; text-align: center; color: #64748b; font-size: 14px;">
      <p>Questions? Reply to this email or contact us at steroideshop@zohomail.com</p>
