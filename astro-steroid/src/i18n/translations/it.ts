...
export const it: Translations = {
    ...
    aboutPage: {
      ...
      content: {
        excellence: 'In Steroiden, ci impegniamo a fornire ai ricercatori peptidi della massima qualità con purezza verificata e documentazione scientifica completa.',
