...
export const de: Translations = {
    ...
    aboutPage: {
      title: 'Peptide sicher kaufen – Über Steroiden',
    ...
    shopPage: {
      ...
      subtitle: 'Peptide kaufen Deutschland: Forschungspeptide mit ≥98% Reinheit, COA-Zertifikat und schnellem Versand. Peptide sicher kaufen bei Steroiden.',
    ...
    home: {
      heroBadge: 'Peptide kaufen Deutschland – Ihr Steroiden',
    ...
    footer: {
      ...
      copyright: '© {year} Steroiden – Peptide kaufen Deutschland. Alle Rechte vorbehalten.',
    },
    common: {
      all: 'Alle',
