...
export const en: Translations = {
    ...
    home: {
      ...
      about: {
        ...
        description: 'Steroiden partners with GMP-certified synthesis facilities and employs PhD-level quality control scientists. Every peptide undergoes dual-verification via HPLC and Mass Spectrometry before release. We supply Semaglutide, BPC-157, Tirzepatide, Retatrutide, and 60+ research-grade compounds with full COA documentation and fast delivery across the UK and Europe.',
      ...
      cta: {
        ...
        subtitle: 'Join thousands of researchers who trust Steroiden.',
