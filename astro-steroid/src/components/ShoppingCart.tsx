          ...
          {products.length === 0 ? (
            <div style={{ ...cardStyle, padding: '80px 40px', textAlign: 'center' }}>
              <div style={{ 
                width: '120px', 
                height: '120px', 
                background: 'linear-gradient(135deg, rgba(26, 46, 90, 0.10), rgba(26, 46, 90, 0.04))',
                borderRadius: '50%',
                display: 'flex',
                alignItems: 'center',
              ...
              <p style={{ color: '#6B6B6B', marginBottom: '32px', fontSize: '1.1rem', maxWidth: '400px', margin: '0 auto 32px' }}>
              ...
              <a 
                ...
                style={{
                  ...
                  fontSize: '16px',
                  transition: 'all 0.3s ease',
                  boxShadow: '0 4px 14px rgba(26, 46, 90, 0.35)'
                }}
              >
            ...
            <>
              <div style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <h4 style={{ color: '#1A1A1A', fontWeight: '700', margin: 0, display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span style={{ color: '#6B6B6B', fontSize: '14px', fontWeight: '600' }}>
                ...
                >
                  <div className="d-flex align-items-start">
                    ...
                    <div style={{ 
                      ...
                      overflow: 'hidden',
                      flexShrink: 0,
                      background: 'linear-gradient(135deg, #F5F0EB, #E0D8D0)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center'
                    }}>
                    ...
                    <div style={{ flex: 1, marginLeft: '20px' }}>
                      ...
                      {/* Quantity & Remove */}
                      <div className="d-flex align-items-center justify-content-between" style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid #EDE8E3' }}>
                        <div className="d-flex align-items-center" style={{ gap: '12px' }}>
                          <span style={{ color: '#6B6B6B', fontSize: '14px', fontWeight: '600' }}>{t(lang, 'cart.quantity')}:</span>
                          <div style={{ 
                            display: 'flex', 
                            alignItems: 'center',
                            background: '#F5F0EB',
                            ...
                            <button
                              ...
                              style={{
                                ...
                                color: product.quantity > 1 ? 'var(--accent-primary)' : '#C4BDB5',
                                fontWeight: '700',
                                fontSize: '18px',
                                display: 'flex',
                                alignItems: 'center',
            ...
            <div style={{ position: 'sticky', top: '100px' }}>
              ...
              <div style={{ ...cardStyle, padding: '28px' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <div className="d-flex justify-content-between" style={{ marginBottom: '12px' }}>
                    ...
                    <span style={{ color: '#1A1A1A', fontWeight: '600' }}>{formatPrice($cartTotal, currency)}</span>
                  </div>
                  
                  <div className="d-flex justify-content-between" style={{ marginBottom: '12px' }}>
                    <span style={{ color: '#6B6B6B' }}>{t(lang, 'cart.shipping')}</span>
                    {qualifiesForFreeDelivery ? (
                      <span style={{ color: '#10b981', fontWeight: '600' }}>{t(lang, 'common.free').toUpperCase()}</span>
                    ) : (
                      <span style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'cart.calculatedAtCheckout')}</span>
                    )}
                  </div>
                ...
                <div style={{ 
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <span style={{ color: '#1A1A1A', fontWeight: '700', fontSize: '1.1rem' }}>{t(lang, 'cart.total')}</span>
                    <span style={{ 
                      color: 'var(--accent-primary)', 
                      fontWeight: '800', 
                      fontSize: '1.5rem'
              ...
              <div style={{ ...cardStyle, padding: '24px', marginTop: '16px' }}>
                ...
                <div style={{ 
                  ...
                  <div>
                    <div style={{ fontWeight: '600', color: '#1A1A1A', fontSize: '14px' }}>{t(lang, 'cart.standardDelivery')}</div>
                    <div style={{ color: '#6B6B6B', fontSize: '13px' }}>{t(lang, 'cart.standardDeliveryTime')}</div>
                  </div>
                ...
                <div style={{ 
                  ...
                  justifyContent: 'space-between',
                  padding: '12px',
                  background: 'linear-gradient(135deg, rgba(26, 46, 90, 0.05), rgba(26, 46, 90, 0.02))',
                  borderRadius: '8px',
                  border: '1px solid rgba(26, 46, 90, 0.18)'
                }}>
                  <div>
                    <div style={{ fontWeight: '600', color: '#1A1A1A', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <div style={{ color: '#6B6B6B', fontSize: '13px' }}>{t(lang, 'cart.expressDeliveryTime')}</div>
                  </div>
                ...
                <div style={{ 
                  ...
                  <div>
                    <div style={{ fontWeight: '600', color: qualifiesForFreeDelivery ? '#059669' : '#6B6B6B', fontSize: '14px' }}>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <div style={{ color: '#1A1A1A', fontWeight: '600', fontSize: '11px' }}>{t(lang, 'cart.secureBadge')}</div>
                </div>
                <div style={{ 
                  ...cardStyle, 
                  padding: '16px 12px', 
                  ...
                  <div style={{ color: '#1A1A1A', fontWeight: '600', fontSize: '11px' }}>{t(lang, 'cart.pureBadge')}</div>
                </div>
                <div style={{ 
                  ...cardStyle, 
                  padding: '16px 12px', 
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#C9A96E" strokeWidth="2" style={{ marginBottom: '8px' }}>
                    <path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"></path>
                    <path d="M15 18H9"></path>
                    <path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14"></path>
                    <circle cx="17" cy="18" r="2"></circle>
                  ...
                  <div style={{ color: '#1A1A1A', fontWeight: '600', fontSize: '11px' }}>{t(lang, 'cart.fastDeliveryBadge')}</div>
                </div>
              </div>
            </div>
          </div>
