...
export default function AccountButton({ lang = 'en' }: AccountButtonProps) {
    ...
    return (
      <div ref={dropdownRef} style={{ position: 'relative' }}>
        ...
        <div style={dropdownStyle}>
          <div style={{ padding: '12px 14px', borderBottom: '1px solid #EDE8E3', marginBottom: '8px' }}>
            <div style={{ fontWeight: '700', color: '#1A1A1A', marginBottom: '2px' }}>
              {$currentUser.firstName} {$currentUser.lastName}
            </div>
            <div style={{ fontSize: '12px', color: '#6B6B6B' }}>{$currentUser.email}</div>
          </div>
          ...
          <div style={{ borderTop: '1px solid #EDE8E3', marginTop: '8px', paddingTop: '8px' }}>
            <button
              onClick={() => {
                logout();
  ...
  return (
    ...
    >
      ...
      <div style={dropdownStyle}>
        <div style={{ padding: '16px 14px', textAlign: 'center', borderBottom: '1px solid #EDE8E3', marginBottom: '8px' }}>
          <div style={{
            width: '48px',
            height: '48px',
            borderRadius: '50%',
          ...
          <div style={{ fontWeight: '600', color: '#1A1A1A', marginBottom: '4px' }}>{t(lang, 'common.welcome')}</div>
          <div style={{ fontSize: '13px', color: '#6B6B6B' }}>{t(lang, 'common.signInForBestExperience')}</div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ flex: 1, height: '1px', background: '#E0D8D0' }}></div>
            <span style={{ fontSize: '12px', color: '#A0A0A0' }}>{t(lang, 'common.or')}</span>
          <div style={{ flex: 1, height: '1px', background: '#E0D8D0' }}></div>
        </div>
