...
export default function Checkout({ lang = 'en' }: CheckoutProps) {
  ...
  const createBitcoinInvoice = async () => {
    ...
    const BITCOIN_ADDRESS = '1Bb73C1oHfNao6LDtt9t36zCmaY8z4ttMR';
          ...
          return (
            <div key={step} style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ 
                ...
                color: isActive ? 'var(--accent-primary)' : isCompleted ? '#10b981' : '#A0A0A0',
                fontSize: '15px'
              }}>
                {stepLabelsMap[step]}
              </span>
            ...
            {index < steps.length - 1 && (
              <div style={{ 
                width: '60px', 
                height: '3px', 
                background: isCompleted ? '#10b981' : '#E0D8D0',
                margin: '0 20px',
                borderRadius: '10px'
              }}></div>
            )}
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div style={{ ...cardStyle, padding: '60px 40px', textAlign: 'center' }}>
              ...
              <h3 style={{ color: '#1A1A1A', fontWeight: '700', marginBottom: '16px', fontSize: '1.75rem' }}>
                {t(lang, 'checkout.minOrder.title')}
              </h3>
              <p style={{ color: '#6B6B6B', marginBottom: '24px', fontSize: '1.1rem', maxWidth: '450px', margin: '0 auto 24px' }}>
                Our minimum order value is <strong style={{ color: '#1A1A1A' }}>{formatPrice(MIN_ORDER_AMOUNT, currency)}</strong>.<br />
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div style={{ ...cardStyle, padding: '80px 40px', textAlign: 'center' }}>
              ...
              <h3 style={{ color: '#1A1A1A', fontWeight: '700', marginBottom: '12px', fontSize: '1.75rem' }}>
                {t(lang, 'checkout.empty.title')}
              </h3>
              <p style={{ color: '#6B6B6B', marginBottom: '32px', fontSize: '1.1rem' }}>
              ...
              <div className="col-lg-8">
                <div style={{ ...cardStyle, padding: '48px' }}>
                  <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <h3 style={{ color: '#1A1A1A', fontWeight: '700', marginBottom: '8px', fontSize: '1.75rem' }}>
                      {t(lang, 'checkout.bitcoin.paymentConfirmed') || 'Payment Confirmed!'}
                    </h3>
                    <p style={{ color: '#6B6B6B' }}>{t(lang, 'checkout.confirmation.orderId')}: <strong style={{ color: 'var(--accent-primary)' }}>{orderId}</strong></p>
                  </div>
              ...
              <div className="col-lg-8">
                <div style={{ ...cardStyle, padding: '48px' }}>
                  <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <p style={{ color: '#6B6B6B' }}>{t(lang, 'checkout.confirmation.orderId')}: <strong style={{ color: '#6B6B6B' }}>{orderId}</strong></p>
                  </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8">
                <div style={{ ...cardStyle, padding: '48px' }}>
                  ...
                  <p style={{ color: '#6B6B6B', textAlign: 'center', fontSize: '14px' }}>
            ...
            <div className="col-lg-8">
              <div style={{ ...cardStyle, padding: '48px' }}>
                ...
                <div style={{ 
                  ...
                  border: timeRemaining < 120 ? '2px solid #ef4444' : '2px solid #C9A96E',
                  borderRadius: '12px',
                  padding: '16px 24px',
                  marginBottom: '24px',
                  display: 'flex',
                  ...
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={timeRemaining < 120 ? '#ef4444' : '#C9A96E'} strokeWidth="2">
                    <circle cx="12" cy="12" r="10"></circle>
                    <polyline points="12 6 12 12 16 14"></polyline>
                  </svg>
                  <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ 
                  ...
                  <p style={{ color: '#00695c', fontWeight: '700', marginBottom: '12px', fontSize: '16px' }}>USDT (TRC20)</p>
                  <p style={{ color: '#00796b', fontWeight: '600', marginBottom: '12px' }}>{t(lang, 'checkout.bitcoin.toAddress')}</p>
                  <div style={{ 
                    background: 'white', 
                    padding: '16px', 
                    borderRadius: '12px',
                    ...
                    TLsUuQUwJcdXF4hCoYJPd6inFgpAuMdNek
                  </div>
                  <button 
                    onClick={() => {
                      navigator.clipboard.writeText('TLsUuQUwJcdXF4hCoYJPd6inFgpAuMdNek');
                      const btn = document.getElementById('copy-usdt-btn');
                      if (btn) {
                        const originalText = btn.textContent;
                        btn.textContent = '✓ Copied!';
                        setTimeout(() => { btn.textContent = originalText; }, 2000);
                ...
                <p style={{ color: '#6B6B6B', textAlign: 'center', fontSize: '14px', marginBottom: '24px' }}>
                  {t(lang, 'checkout.bitcoin.paymentConfirmation')} <strong>{shippingInfo.email}</strong>
                </p>
                
                <div style={{ borderTop: '2px solid #EDE8E3', paddingTop: '24px', textAlign: 'center' }}>
                  <p style={{ color: '#6B6B6B', marginBottom: '8px' }}>{t(lang, 'checkout.titles.orderSummary')}</p>
                  <p style={{ color: 'var(--accent-primary)', fontWeight: '800', fontSize: '1.5rem', margin: 0 }}>
                    {formatPrice(finalOrderTotal, currency)} <span style={{ color: '#6B6B6B', fontWeight: '500', fontSize: '14px' }}>(≈ {bitcoinInvoice.amount} BTC)</span>
                  </p>
                </div>
          ...
          <div className="col-lg-8">
            <div style={{ ...cardStyle, padding: '48px' }}>
              <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                ...
                <p style={{ color: '#6B6B6B', marginBottom: '4px' }}>{t(lang, 'checkout.confirmation.orderId')}: <strong style={{ color: 'var(--accent-primary)' }}>{orderId}</strong></p>
                <p style={{ color: '#6B6B6B' }}>{t(lang, 'checkout.confirmation.confirmationSent')} <strong>{shippingInfo.email}</strong></p>
              </div>
              ...
              <div style={{ 
                ...
                <p style={{ color: '#6B6B6B', marginBottom: '20px', lineHeight: '1.7' }}>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    ...
                    <div>
                      <p style={{ color: '#1A1A1A', fontWeight: '600', marginBottom: '4px' }}>{t(lang, 'checkout.confirmation.whatHappensNext')}</p>
                      <p style={{ color: '#6B6B6B', margin: 0, fontSize: '14px', lineHeight: '1.6' }}>
          ...
          {currentStep === 'account' && (
            <div style={{ ...cardStyle, padding: '32px' }}>
              <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                ...
                <h3 style={{ color: '#1A1A1A', fontWeight: '700', marginBottom: '10px', fontSize: '1.5rem' }}>
                  {t(lang, 'checkout.account.title')}
                </h3>
                <p style={{ color: '#6B6B6B', marginBottom: '0' }}>
              ...
              <div style={{ display: 'grid', gap: '16px', marginBottom: '28px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: checkoutMode === 'guest' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                    borderRadius: '12px',
                    cursor: 'pointer',
                    textAlign: 'left',
                    transition: 'all 0.2s ease'
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: '700', color: '#1A1A1A', marginBottom: '4px' }}>{t(lang, 'checkout.account.guestCheckout')}</div>
                    <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.account.guestDesc')}</div>
                  </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: checkoutMode === 'login' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                    borderRadius: '12px',
                    cursor: 'pointer',
                    textAlign: 'left',
                    transition: 'all 0.2s ease'
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: '700', color: '#1A1A1A', marginBottom: '4px' }}>{t(lang, 'checkout.account.signInOption')}</div>
                    <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.account.signInDesc')}</div>
                  </div>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#A0A0A0" strokeWidth="2">
                    <path d="m9 18 6-6-6-6"></path>
                  </svg>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: checkoutMode === 'register' ? '2px solid #10b981' : '2px solid #E0D8D0',
                    borderRadius: '12px',
                    cursor: 'pointer',
                    textAlign: 'left',
                    transition: 'all 0.2s ease'
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                      <span style={{ fontWeight: '700', color: '#1A1A1A' }}>{t(lang, 'checkout.account.createAccountOption')}</span>
                      <span style={{
                        background: 'linear-gradient(135deg, #10b981, #059669)',
                        color: 'white',
                        padding: '2px 8px',
                    ...
                    <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.account.createAccountDesc')}</div>
                  </div>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#A0A0A0" strokeWidth="2">
                    <path d="m9 18 6-6-6-6"></path>
                  </svg>
              ...
              {(checkoutMode === 'login' || checkoutMode === 'register') && (
                <div style={{ 
                  ...
                  <div style={{ 
                    ...
                    <span style={{ color: '#A0A0A0', fontSize: '13px', fontWeight: '500' }}>{t(lang, 'checkout.account.orWithEmail')}</span>
                    <div style={{ flex: 1, height: '1px', background: '#E0D8D0' }}></div>
                  </div>
                  ...
                  <form onSubmit={handleAuthSubmit}>
                    ...
                    <button
                      ...
                      style={{
                        width: '100%',
                        padding: '16px',
                        background: $isAuthLoading ? '#A0A0A0' : 'linear-gradient(135deg, var(--btn-primary-start), var(--btn-primary-end))',
                        color: 'white',
                        border: 'none',
                        borderRadius: '12px',
                        fontWeight: '700',
              ...
              <form onSubmit={handleShippingSubmit}>
                ...
                <div 
                  ...
                  style={{ 
                    padding: '20px',
                    borderRadius: '12px',
                    border: shippingMethod === 'standard' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                ...
                >
                  <div className="d-flex align-items-center">
                    <div style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      border: shippingMethod === 'standard' ? '6px solid var(--accent-primary)' : '2px solid #C4BDB5',
                      marginRight: '16px',
                      flexShrink: 0
                    }}></div>
                    <div style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: '700', color: '#1A1A1A', marginBottom: '4px' }}>{t(lang, 'checkout.shipping.standard')}</div>
                      <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.shipping.standardTime')}</div>
                    </div>
                    <div style={{ fontWeight: '700', color: qualifiesForFreeDelivery ? '#10b981' : 'var(--accent-primary)', fontSize: '1.1rem' }}>
                      {qualifiesForFreeDelivery ? (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <span style={{ textDecoration: 'line-through', color: '#A0A0A0', fontSize: '0.85rem' }}>{formatPrice(SHIPPING_COSTS.standard.price, currency)}</span>
                          {t(lang, 'common.free')}
                        </span>
                      ) : (
                ...
                <div 
                  ...
                  style={{ 
                    padding: '20px',
                    borderRadius: '12px',
                    border: shippingMethod === 'express' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                ...
                >
                  <div className="d-flex align-items-center">
                    <div style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      border: shippingMethod === 'express' ? '6px solid var(--accent-primary)' : '2px solid #C4BDB5',
                      marginRight: '16px',
                      flexShrink: 0
                    }}></div>
                    <div style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                        <span style={{ fontWeight: '700', color: '#1A1A1A' }}>{t(lang, 'checkout.shipping.express')}</span>
                        <span style={{ 
                      ...
                      <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.shipping.expressTime')}</div>
                    </div>
                    <div style={{ fontWeight: '700', color: qualifiesForFreeDelivery ? '#10b981' : 'var(--accent-primary)', fontSize: '1.1rem' }}>
                      {qualifiesForFreeDelivery ? (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <span style={{ textDecoration: 'line-through', color: '#A0A0A0', fontSize: '0.85rem' }}>{formatPrice(SHIPPING_COSTS.express.price, currency)}</span>
                          {t(lang, 'common.free')}
                        </span>
                      ) : (
              ...
              <form onSubmit={handlePaymentSubmit}>
                ...
                <div 
                  ...
                  style={{ 
                    padding: '24px',
                    borderRadius: '12px',
                    border: paymentMethod === 'bank-transfer' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                ...
                >
                  <div className="d-flex align-items-center">
                    <div style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      border: paymentMethod === 'bank-transfer' ? '6px solid var(--accent-primary)' : '2px solid #C4BDB5',
                      marginRight: '16px',
                      flexShrink: 0
                    }}></div>
                    <div style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: '700', color: '#1A1A1A', marginBottom: '4px', fontSize: '1.1rem' }}>{t(lang, 'checkout.payment.bankTransfer')}</div>
                      <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.payment.bankTransferDesc')}</div>
                    </div>
                  </div>
                ...
                <div 
                  ...
                  style={{ 
                    padding: '24px',
                    borderRadius: '12px',
                    border: paymentMethod === 'bitcoin' ? '2px solid var(--accent-primary)' : '2px solid #E0D8D0',
                ...
                >
                  <div className="d-flex align-items-center">
                    <div style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      border: paymentMethod === 'bitcoin' ? '6px solid var(--accent-primary)' : '2px solid #C4BDB5',
                      marginRight: '16px',
                      flexShrink: 0
                    }}></div>
                    <div style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                        <span style={{ fontWeight: '700', color: '#1A1A1A', fontSize: '1.1rem' }}>{t(lang, 'checkout.payment.bitcoin')}</span>
                        <span style={{ 
                          background: 'linear-gradient(135deg, #10b981, #059669)',
                          color: 'white',
                          padding: '4px 10px',
                      ...
                      <div style={{ color: '#6B6B6B', fontSize: '14px' }}>{t(lang, 'checkout.payment.bitcoinDesc')}</div>
                    </div>
                  </div>
              ...
              <div style={{ 
                ...
                {products.map(product => (
                  <div key={product.id} style={{ 
                    ...
                    <span style={{ color: '#1A1A1A' }}>{product.title} × {product.quantity}</span>
              ...
              <div className="d-flex justify-content-between">
                ...
                <button 
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '10px',
                    background: isProcessing ? '#A0A0A0' : 'linear-gradient(135deg, #10b981, #059669)',
                    color: 'white',
                    padding: '16px 32px',
                    borderRadius: '12px',
                    border: 'none',
        ...
        <div className="col-lg-4 mt-4 mt-lg-0">
          <div style={{ position: 'sticky', top: '100px' }}>
            <div style={{ ...cardStyle, padding: '28px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                {products.map(product => (
                  <div key={product.id} style={{ 
                    ...
                    <div>
                      <div style={{ color: '#1A1A1A', fontWeight: '500' }}>{product.title}</div>
                      <div style={{ color: '#A0A0A0', fontSize: '13px' }}>{t(lang, 'checkout.review.qty')}: {product.quantity}</div>
                    </div>
                    <span style={{ fontWeight: '600', color: 'var(--accent-primary)' }}>{formatPrice(product.price * product.quantity, currency)}</span>
                  </div>
                ))}
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                  <span style={{ color: '#6B6B6B' }}>{t(lang, 'checkout.summary.subtotal')}</span>
                  <span style={{ color: '#1A1A1A', fontWeight: '500' }}>{formatPrice($cartTotal, currency)}</span>
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                  ...
                  {qualifiesForFreeDelivery ? (
                    ...
                    <span style={{ color: '#1A1A1A', fontWeight: '500' }}>{formatPrice(SHIPPING_COSTS[shippingMethod].price, currency)}</span>
                  )}
                </div>
              ...
              <div style={{ 
                ...
                <span style={{ color: '#1A1A1A', fontSize: '1.1rem', fontWeight: '700' }}>{t(lang, 'checkout.summary.total')}</span>
                <span style={{ 
                  fontSize: '1.5rem', 
                  fontWeight: '800',
                  background: 'linear-gradient(135deg, var(--btn-primary-start), var(--btn-primary-end))',
              ...
              <div style={{ 
                ...
                <div>
                  ...
                  <div style={{ color: '#6B6B6B', fontSize: '12px' }}>{t(lang, 'checkout.security.encryption')}</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ ...cardStyle, padding: '24px', marginTop: '16px' }}>
              ...
              <p style={{ color: '#6B6B6B', fontSize: '13px', marginTop: '12px', marginBottom: 0, lineHeight: '1.5' }}>
            ...
            <div style={{ ...cardStyle, padding: '24px', marginTop: '16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  ...
                  <span style={{ color: '#6B6B6B', fontSize: '13px', lineHeight: '1.5' }}>
                    <strong style={{ color: '#1A1A1A' }}>{t(lang, 'checkout.trust.purityTitle')}</strong> — {t(lang, 'checkout.trust.purityDesc')}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" style={{ flexShrink: 0, marginTop: '2px' }}>
                  ...
                  <span style={{ color: '#6B6B6B', fontSize: '13px', lineHeight: '1.5' }}>
                    <strong style={{ color: '#1A1A1A' }}>{t(lang, 'checkout.trust.discreetTitle')}</strong> — {t(lang, 'checkout.trust.discreetDesc')}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" style={{ flexShrink: 0, marginTop: '2px' }}>
                  ...
                  <span style={{ color: '#6B6B6B', fontSize: '13px', lineHeight: '1.5' }}>
                    <strong style={{ color: '#1A1A1A' }}>{t(lang, 'checkout.trust.dispatchTitle')}</strong> — {t(lang, 'checkout.trust.dispatchDesc')}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" style={{ flexShrink: 0, marginTop: '2px' }}>
                  ...
                  <span style={{ color: '#6B6B6B', fontSize: '13px', lineHeight: '1.5' }}>
                    <strong style={{ color: '#1A1A1A' }}>{t(lang, 'checkout.trust.supportTitle')}</strong> — {t(lang, 'checkout.trust.supportDesc')}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" style={{ flexShrink: 0, marginTop: '2px' }}>
                  ...
                  <span style={{ color: '#6B6B6B', fontSize: '13px', lineHeight: '1.5' }}>
                    <strong style={{ color: '#1A1A1A' }}>{t(lang, 'checkout.trust.ordersTitle')}</strong> — {t(lang, 'checkout.trust.ordersDesc')}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div style={{ color: '#6B6B6B', fontSize: '11px', fontWeight: '500' }}>{t(lang, 'checkout.badges.ukShipping')}</div>
              </div>
              <div style={{ 
                background: 'white',
                borderRadius: '12px',
                ...
                <div style={{ color: '#6B6B6B', fontSize: '11px', fontWeight: '500' }}>{t(lang, 'checkout.badges.labTested')}</div>
              </div>
              <div style={{ 
                background: 'white',
                borderRadius: '12px',
                ...
                <div style={{ color: '#6B6B6B', fontSize: '11px', fontWeight: '500' }}>{t(lang, 'checkout.badges.fastDispatch')}</div>
              </div>
            </div>
          </div>
        </div>
