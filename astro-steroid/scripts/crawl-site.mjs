...
const seedPaths = [
  ...
  '/nl/steroids/bacteriostatic-water-kopen/',
  '/de/steroids/bacteriostatic-water-kaufen/',
  '/fr/steroids/acheter-de-l-eau-bacteriostatique/',
  '/es/steroids/agua-bacteriostatica-comprar/',
  '/it/steroids/acquisto-acqua-batteriostatica/',
];
